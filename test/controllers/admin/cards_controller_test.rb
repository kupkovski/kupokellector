...
class Admin::CardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_card" do
    assert_difference("Admin::Card.count") do
      post admin_cards_url, params: { admin_card: { collection_number: @admin_card.collection_number, name: @admin_card.name } }
    end
  ...
  test "should update admin_card" do
    patch admin_card_url(@admin_card), params: { admin_card: { collection_number: @admin_card.collection_number, name: @admin_card.name } }
